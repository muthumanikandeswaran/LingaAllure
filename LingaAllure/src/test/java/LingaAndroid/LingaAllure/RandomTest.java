...
public class RandomTest extends LingaBase {
	...
	public void tryOne() throws InterruptedException, IOException {
		...
		/*
		 * acp.ByName.click(); acp.ByPhone.click(); acp.one.click();
		 * //acp.Backspace.click(); acp.zero.click(); acp.AddcustomerButton.click();
		 * dr.hideKeyboard(); cpsp.CancelCustomerProfileScreen.click();
		 * Thread.sleep(2000); dp.CustomerAdd.click();
		 */
		acp.ByName.click();
		...
		/*
		 * Thread.sleep(2000); op.OperationList.click(); op.CloseDay.click();
		 * cdp.CloseAllCashiers.click(); cdp.Cancel.click(); cdp.CloseTheDay.click();
		 * cdp.Yes.click(); Thread.sleep(8000); cdp.ActiveChecks.click();
		 * Thread.sleep(2000); cdp.ActiveCheckCancel.click(); cdp.OpenCashier.click();
		 * cdp.Cancel.click(); cdp.EmployeeSelectionDropdown.click();
		 * cdp.Cancel.click(); Thread.sleep(2000); op.OperationList.click();
		 * op.POS.click(); dp.Cancel.click();
		 */
		 ...
		 * 
		 * //dp.OperationInOrderScreen.click(); op.BatchTipAdjustment.click();
		 * Thread.sleep(3000); bp.ApplyTotalToggle.click();
		 * 
		 * bp.DeviceSelection.click();
		 * 
		 * bp.GiftCardDevice.click(); Thread.sleep(2000); bp.UserSelection.click();
		 * 
		 * bp.ShriUser.click();
		 * 
		 * bp.Search.click(); bp.Search.sendKeys("Kathija"); op.Logout.click();
		 */
