...
public class CheckSkip_OnOpeningAnyActiveCheck_Test  extends LingaBase {

	@Test
	public void CheckSkip_OnOpeningAnyActiveCheck() throws InterruptedException, IOException  {
		...
		dr.findElement(By.xpath("//android.widget.Button[@resource-id='menu-item-0']")).click();
		dp.Finish.click();
		...
		dp.INRPay.click();
		dp.Submit.click();
		csp.CheckStatus.click();
		csp.CheckSearch.sendKeys(check1);
		dr.hideKeyboard();
		Thread.sleep(1000);
		dr.findElement(By.xpath("//android.view.View[@text='"+check1+"']")).click();
		csp.OpenCheck.click();
		dp.Payment.click();
		dp.INRPay.click();
		dp.Submit.click();
		...
		System.out.println("***Check skip verification***");
		System.out.println(check1);
		System.out.println(check2);
		System.out.println(check3);
		dp.All.click();
