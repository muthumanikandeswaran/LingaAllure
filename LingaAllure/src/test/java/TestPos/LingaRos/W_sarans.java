...
public class W_sarans extends LingaBase {
	...
	public void Continuous_ActiveChecks_Test() throws InterruptedException, IOException {
		...
		dr2.findElement(By.xpath(".//*[text()= \"Payment\"]")).click();
		dr2.findElement(By.xpath(".//*[text()= \"Cash\"]")).click();
		dr2.findElement(By.xpath(".//*[text()= \" Success\"]")).click();
		dr2.findElement(By.xpath(".//*[text()= \"Delete\"]")).click();
		dr2.findElement(By.xpath(".//*[text()= \"Side CC\"]")).click();
		Thread.sleep(10000);
