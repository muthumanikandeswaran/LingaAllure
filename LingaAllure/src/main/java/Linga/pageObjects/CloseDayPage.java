...
public class CloseDayPage {
	...
	public WebElement CheckListSubmit  ;
	
	@AndroidFindBy(xpath="(//android.widget.Button)[1]")
	public WebElement CheckListCancel  ;
	
	
	@AndroidFindBy(xpath="(//android.widget.Button)[3]")
	public WebElement ActiveCheckCancel  ;
	
	
	@AndroidFindBy(xpath="(//android.view.View)[17]")
	public WebElement ActiveChecks  ;
	
	@AndroidFindBy(xpath="(//android.view.View)[29]") //29-first 
